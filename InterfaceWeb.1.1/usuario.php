...
<div class="col">
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <a class="dropdown-item" href="user_novo_register_teceiro.php">Registror de novo usuario</a>
      <a class="dropdown-item" href="user_troca_senha.php">Esqueceu a senha</a>
