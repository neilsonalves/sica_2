        ...
        <form>
          <div class="form-group">
            <div class="form-label-group">
              <input type="password" id="inputSenhaAnterio" class="form-control" placeholder="Senha Anterio" required="required" autofocus="autofocus">
              <label for="inputSenhaAnterio">Senha Anterio</label>
            </div>
            <div class="form-label-group">
              <input type="text" id="inputNovaSenha" class="form-control" placeholder="Nova Senha" required="required" autofocus="autofocus">
              <label for="inputNovaSenha">Nova Senha</label>
            </div>
            <div class="form-label-group">
              <input type="text" id="inputConfirmaSenha" class="form-control" placeholder="Confirma Senha" required="required" autofocus="autofocus">
              <label for="inputConfirmaSenha">Confirma Senha</label>
            </div>
          </div>
          <button class="btn btn-primary btn-block" type="submit">Redefinir</button>
        </form>
      </div>
    </div>
